...
def delete_review_by_id(review_id):
    deleted_review = Review.objects.filter(id=review_id).delete()
    return str(deleted_review)
...
def filter_authors_by_nationalities(nationality):
    ...
    for a in authors:
        result.append(a.biography) if a.biography else result.append(f'{a.first_name} {a.last_name}')
